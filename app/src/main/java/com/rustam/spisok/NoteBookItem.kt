...
fun NoteBookItem(
    ...
    Card(
        ...
        modifier = Modifier
            ...
            .clickable {
                ...
                noteBookVM.noteBook = item
                noteBookVM.newDesc.value = item.desc
            },
    ...
    if (openDialog.value) EditDescNoteBook(openDialog = openDialog, noteBookVM = noteBookVM, item = item)
}